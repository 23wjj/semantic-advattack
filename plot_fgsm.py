...
input=np.load("fgsm_attack/0.3_epsilon/data/adv_pred.npz")
init_preds=input['init_preds'].tolist()
final_preds=input['final_preds'].tolist()
adv_examples=np.load("fgsm_attack/0.3_epsilon/data/adv_example.npz")['adv_examples']
orig_examples=np.load("fgsm_attack/0.3_epsilon/data/orig_example.npz")['orig_examples']
recover_img=np.load("fgsm_attack/0.3_epsilon/data/recover_example.npz")['recover_examples']
...
# ax.set_title('Target Adversarial Frequency under FGSM (epsilon=0)')
# ax.set_xticks(x)
...
# plt.savefig('./adv_target_0_1.png')
...
plt.tight_layout()
plt.savefig("fgsm_res_0.3_1.png")